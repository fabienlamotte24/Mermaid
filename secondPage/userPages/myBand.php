...
//Si $successUrl existe (car la condition aura bien vérifié que l'url 
//décline une valeur id d'un groupe dont l'utilisateur est bien le propriétaire
                        ...
                        <div class="bandContent row p-0 m-0 ">
                            <div class="col-12 text-center border">
                                ...
                                <form action="myBand.php?id=<?= $showBand->id ?>" method="POST" enctype="multipart/form-data" class="form-group offset-xl-3 offset-lg-3 offset-md-3 offset-sm-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <img src="../../assets/img/bandPictures/avatars/<?= $showBand->bandPicture ?>" class="rounded-circle mb-2" width="70" height="70" title="Photo de profil de l'établissement" alt="Photo de profil de l'établissement" />                            
                                    ...
                                    <!--Changement du nom-->
                                    <label for="bandName">Nom de votre établissement: </label>
                                    <input type="text" class="form-control" value="<?= $showBand->bandName ?>" name="bandName" id="bandName" />
                                    ...
                                    <textarea name="bandDescription" id="bandDescription" class="form-control" ><?= $showBand->bandDescription ?></textarea>
                                    <p class="red"><?= (isset($errorList['bandDescription'])) ? $errorList['bandDescription'] : '' ?></p>

                                    <!--Boutton de validation-->
                                    <input type="submit" name="changeBandContent" class="form-control" value="Modifier" />

                                    <!--Boutton de suppression-->
                                    <a href="#" data-toggle="modal" class="buttonRemove" data-target="#myModal">
                                        <button class="form-control">Supprimer mon groupe de musique</button>
                                    </a>
                            ...
                            <?php if ($checkAnnounce != 0) { ?>
                                <div class="col-12 text-center">
                                    ...
                                    <form action="myBand.php?id=<?= $showBand->id ?>" method="POST" class="form-group offset-xl-3 offset-lg-3 offset-md-3 offset-sm-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12">

                                        <!--Champs d'annonce-->
                                        <label for="announce">Votre annonce</label>
                                        <textarea name="announce" id="announce" class="form-control"><?= $showBand->research ?></textarea>

                                        <!--Boutton de validation-->
                                        <input type="submit" name="changeAnnounce" class="form-control" value="Modifier" />
