...
<html lang="fr" dir="ltr">
    <head>
        ...
        <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.5.0/css/all.css" integrity="sha384-B4dIYHKNBt8Bc12p+WXckhzcICo0wtJAoU8YZTY5qE0Id1GSseTk6S+L3BlXeVIU" crossorigin="anonymous">        <link rel="stylesheet" href="../../assets/css/navOnline.css" />
...
<?php if ($_SESSION['idType'] == 1) { ?>
                body{
                    background-image:url('../../assets/img/qsd.jpg');
                    background-size:cover;
                    background-repeat: no-repeat;
                }
<?php } else if ($_SESSION['idType'] == 2) { ?>
                body{
                    background-image:url('../../assets/img/barLive.jpg');
                    background-size:cover;
                    background-repeat: no-repeat;
                }
<?php } else if ($_SESSION['idType'] == 3) { ?>
                body{
                    background-image:url('../../assets/img/musicienCarousel.jpeg');
                    background-size:cover;
                    background-repeat: no-repeat;
                }
<?php } ?>
            ...
            <div class="container-fluid">
                ...
                <section>
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="profilBlock offset-md-1 offset-sm-1 col-xl-6 col-lg-6 col-md-10 col-sm-10 col-xs-12 mt-3">
                        ...
                        <div class="establishmentBlock offset-xl-2 offset-lg-2 offset-md-2 offset-sm-2 offset-xs-0 col-xl-3 col-lg-3 col-md-3 col-sm-8 col-xs-12 mt-4 p-2">
                        ...
                        <?php foreach ($showEstablishments as $companies) { ?>
                            <div class="establishmentBlock offset-xl-2 offset-lg-2 offset-md-2 offset-sm-2 offset-xs-0 col-xl-3 col-lg-3 col-md-3 col-sm-8 col-xs-12 mt-4 p-2" id="<?= $companies->id ?>">
            ...
            <div class="container-fluid">
                ...
                <section>
                        ...
                        <div class="profilBlock offset-xl-1 offset-lg-1 offset-md-1 offset-md-1 offset-sm-1 col-xl-3 col-lg-3 col-lg-3 col-md-10 col-sm-10 col-xs-12 mt-3">
                            <div class="row profilBlockContent p-3">
                                <div class="col-12 text-center m-0 p-0 text-center">
                                    ...
                                    <a href="options.php" class="linkOptions row text-center">
                                        <div class="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-xs-12 d-flex text-center ml-4 p-0">
                                            <?php if ($_SESSION['profilPicture'] == ' ') { ?>
                                                <img src="../../assets/img/icoUser.png" class="rounded-circle icoUser border p-0 m-0" width="70" height="70" alt="Photo de profil" title="Photo de profil" />
                                            <?php } else { ?>
                                                <img src="../../assets/img/userPictures/avatars/<?= $_SESSION['profilPicture'] ?>" class="rounded-circle icoUser" width="70" height="70" alt="Photo de profil" title="Photo de profil" />
                                        ...
                                        <div class="mt-3 ml-2">
                                            <h1 class="profilePseudo text-center"><?= $_SESSION['pseudo'] ?></h1>
                                        </div>
                                    </a>
                                    <?php if ($choice == 0) { ?>
                                        ...
                                        <form method="POST" action="#" class="form-group text-center">
                                            ...
                                            <select name="instrument" id="instrument" class="form-control ">
                                                ...
                                                <?php } ?>
                                                <input type="submit" name="submitInstrumentChoice" />
                                                <span class="red"><?= (isset($errorList['instrument'])) ? $errorList['instrument'] : '' ?></span>
                                            </select>
                                        </form>
                                    <?php } else { ?>
                                        <!--Div qui affiche le rôle du musicien-->
                                        <div class="showRoleOfMusician row">
                                            <div class="col-12 ml-5 d-flex">  
                                                <img src="../../assets/img/instruments/<?= $role->id_15968k4_typeInstrument ?>.png" title="rôle du musicien" alt="rôle du musicien" class="rounded-circle border" width="50" height="50" /> 
                                                <p class="mt-3"><?= $role->instrument ?></p>   
                                            </div>      
                                            <!--Lien de modification de role-->
                                            <p class="ml-4">Cliquez <span class="linkChangeInstrument blue">ici</span> pour changer de rôle</p>
                                        </div>
                                        ...
                                        <div class="row changeInstrument">
                                            <!--Formulaire de modification de role-->
                                            <form method="POST" action="#" class="form-group text-center">
                                                ...
                                                <input type="submit" name="submitChangeInstrumentChoice" />
                                                <span class="red"><?= (isset($errorList['instrument'])) ? $errorList['instrument'] : '' ?></span>
                                            </form>
                                        </div>
                                    <?php } ?>
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="bandBlock offset-xl-2 offset-lg-2 offset-md-2 offset-sm-2 offset-xs-0 col-xl-3 col-lg-3 col-md-3 col-sm-8 col-xs-12 mt-4 p-2">
                        ...
                        <!--Affichage de tout les groupes de musique-->
                        <?php foreach ($allMyBands as $bands) { ?>
                            <div class="bandBlock offset-xl-2 offset-lg-2 offset-md-2 offset-sm-2 offset-xs-0 col-xl-3 col-lg-3 col-md-3 col-sm-8 col-xs-12 mt-4 p-2" id="<?= $bands->id ?>">
                                <div class="bandContent col-12 text-center border p-0 pt-3">
                                    <div class="row mt-2">
                                        <div class="col-12 text-center">
                                            <a href="myBand.php?id=<?=$bands->id?>" class="d-flex text-center Titleband">
                                                <img src="../../assets/img/bandPictures/avatars/<?= $bands->bandPicture ?>" class="rounded-circle" width="70" height="70" title="Photo de mon groupe de musique" alt="Photo de mon groupe de musique"/>                                            
