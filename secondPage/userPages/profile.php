            ...
            <div class="container-fluid">
                ...
                <section>
                    ...
                    <div class="row">
                        ...
                        <div class=" offset-md-1 offset-sm-1 col-xl-6 col-lg-10 blockEstablishement owl-carousel owl-theme mb-5" data-ride="carousel">
                            <?php foreach ($showEstablishments as $companies) { ?>
                                <div class="establishmentBlock col-12 mt-3 p-2 h-100 item" id="<?= $companies->id ?>">
        ...
        <section>
            ...
            <div class="row">
                ...
                <div class="row mt-5 col-xl-7 col-lg-7 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div id="blockBand" class=" col-xl-8 col-lg-8 col-md-10 col-sm-10 col-xs-12 owl-carousel owl-theme" id="carousel" data-ride="carousel">
                        <!--Affichage de tout les groupes de musique-->
                        <?php foreach ($allMyBands as $bands) { ?>
                            <div class="bandBlock item" id="<?= $bands->id ?>">
                                <div class="bandContent col-12 text-center border p-0 pt-3">
                                    <div class="row mt-2 text-center">
                                        <a href="myBand.php?id=<?= $bands->id ?>" class="d-flex text-center Titleband">
                                            ...
                                            <div class="col-7">
                                                <h1 class="bandName pr-5"><?= $bands->bandName ?></h1>                    
                                            </div>
                                        </a>
                                    </div>
                                    <div class="row mt-4">
