...
class users extends database {
    //Listing des attributs représentant les champs de la table 15968k4_users
    public $id = 0;
    public $pseudo = '';
    public $password = '';
    public $mail = '';
    ...
    public function addUser() {
        ...
        $query = 'INSERT INTO `15968k4_users`(`pseudo`, `password`, `mail`, `lastname`, `firstname`, `phoneNumber`, `birthDate`, `address`, '
                . '`id_15968k4_Type`, `id_15968k4_Cities`, `profilPicture`) '
                . 'VALUES(:pseudo, :password, :mail, :lastname, :firstname, :phoneNumber, :birthDate, :address, :id_15968k4_Type, '
                . ':id_15968k4_Cities, :profilPicture)';
    ...
    public function userConnexion() {
        $state = FALSE;
        $query = 'SELECT `us`.`id`, `us`.`pseudo`, `us`.`password`, `us`.`mail`, `us`.`lastname`, `us`.`firstname`, `us`.`phoneNumber`, '
                . 'DATE_FORMAT(`us`.`birthDate`, \'%m-%d-%Y\') AS `birthDate`, `us`.`address`, `us`.`id_15968k4_type`, `us`.`id_15968k4_cities`, '
                . '`us`.`profilPicture`, `ci`.city, `ci`.`postalCode` '
    ...
    public function showCompleteUserContent() {
        $query = 'SELECT `us`.`id`, `us`.`pseudo`, `us`.`password`, `us`.`mail`, `us`.`lastname`, `us`.`firstname`, '
                . '`us`.`phoneNumber`, DATE_FORMAT(`us`.`birthDate`, \'%m-%d-%Y\') AS `birthDate`, `us`.`address`, `us`.`id_15968k4_type`, '
                . '`us`.`id_15968k4_cities`,`us`.`profilPicture`, `ci`.city, `ci`.`postalCode` '
                . 'FROM `15968k4_users` AS `us` '
                . 'LEFT JOIN `15968k4_cities` AS `ci` '
                . 'ON `us`.`id_15968k4_cities` = `ci`.`id` '
                . 'WHERE `us`.`id` = :id ';
