...
include_once'controllers/musicianRegisterCtrl.php';
?>
<!DOCTYPE html>
    ...
    <body>
        <div class="container-fluid">
            ...
            <section id="section" class="col-12 text-center">
                <form id="form-data" class="<?= (isset($_POST['submit']) && count($errorList) == 0) ? 'invisible' : 'form' ?> 
                      offset-xl-2 offset-lg-2 offset-md-2 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12 form-group text-center" action="#" 
                      method="POST">                
                    ...
                    <div id="firstBlock">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" id="pseudo" name="pseudo" class="form-control text-center" maxlength="20" 
                            ...
                            <div class="col-6">
                                ...
                                <input type="mail" id="mail" name="mail" class="form-control text-center" maxlength="30" 
                            ...
                            <div class="col-6">
                                ...
                                <input type="password" id="pass" name="pass" placeholder="Ecrivez un mot de passe" 
                                       class="form-control text-center" maxlength="20" 
                            ...
                            <div class="col-6">
                                ...
                                <input type="password" id="passRepeat" name="passRepeat" placeholder="Réécrivez le mot de passe" 
                                       class="form-control text-center" maxlength="20" 
                                       value="<?= (isset($_POST['passRepeat'])) ? $_POST['passRepeat'] : ''; ?>" />                            
                    ...
                    <div id="secondBlock">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" id="lastname" name="lastname" class="form-control text-center" maxlength="15" 
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" id="firstname" name="firstname" class="form-control text-center" maxlength="15" 
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" id="phoneNumber" name="phoneNumber" class="form-control text-center" 
                                       maxlength="10" value="<?= (isset($_POST['phoneNumber'])) ? $_POST['phoneNumber'] : ''; ?>" />                                                        
                    ...
                    <div id="thirdBlock">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" id="adress" name="address" class="form-control text-center" 
                                       maxlength="100" value="<?= (isset($_POST['address'])) ? $_POST['address'] : ''; ?>" />
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" name="postalCode" id="postalCode" class="form-control" 
                                       value="<?= (isset($_POST['postalCode'])) ? $_POST['postalCode'] : ''; ?>" />
                            ...
                            <div class="col-6">
                                ...
                                <select name="city" id="citySelect" class="form-control">
                                    <option name="<?= (isset($_POST['city'])) ? $_POST['city'] : 0 ?>" 
                                            value="<?= (isset($_POST['city'])) ? $_POST['city'] : 0 ?>">
                                           <?= (isset($rightCity->city)) ? $rightCity->city : 'Renseignez votre code postal' ?></option>
                                </select>
                            </div>
                        </div>
                        <p class="red"><?= (isset($errorList['cities'])) ? $errorList['cities'] : '' ?></p>
                    </div>
                    <div class="submit">
                        <input type="submit" name="submit" value="Je valide mon inscription !" />
                    </div>
                </form>
                <div id="result" class="<?= (isset($_POST['submit']) && count($errorList) == 0) ? 'blockForm' : 'invisible' ?> 
                     offset-xl-4 offset-lg-2 offset-md-2 col-xl-4 col-lg-8 col-md-8 col-sm-12 col-xs-12 form-group text-center">
