<!--Création d'une barre de navigation avec bootstrap4-->
          ...
          <li class="nav-item">
              <!--Section d'Identifiant de l'utilisateur-->
                <div id="user">
                    ...
                    <abbr><a href="../secondPage/userForget.php" class="forgot">Oublié ?</a></abbr>
                </div>
          </li>
          <li class="nav-item">
              <!--Section de Mot de passe de l'utilisateur-->
                <div id="Pass">
                    ...
                    <abbr><a href="../secondPage/passForget.php" class="forgot">Oublié ?</a></abbr>
                </div>
          </li>
          <li class="nav-item">
              <!--Section de Validation d'entrée de login et de mot de passe pour accéder au site-->
                <div id="connexion">
                    ...
                    <a href="#" class="signIn">Inscription</a>
                </div>
          </li>    
        </ul>
      </form>
